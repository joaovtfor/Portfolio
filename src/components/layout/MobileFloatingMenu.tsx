        ...
        {isOpen && (
          ...
          >
            ...
            <button
              ...
              className="flex items-center gap-3 px-5 py-3 bg-[var(--foreground)] text-black rounded-full text-xs uppercase tracking-widest font-sans font-bold shadow-[0_0_20px_rgba(133,232,234,0.3)] /* theme: foreground */ active:scale-95 transition-transform"
            >
